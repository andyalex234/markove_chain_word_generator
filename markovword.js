...
// A function to split a txt up into tokens
...
String.prototype.tokenize = function() {
  ...
  function MarkovGeneratorWord(n, max) {
    ...
    this.ngrams = {};
    // A separate array of possible beginnings to generated txt
    this.beginnings = [];
  
    // A function to feed in txt to the markov chain
    this.feed = function(txt) {
  
      var tokens = txt.tokenize();
    ...
    // Generate a txt from the information ngrams
